...
(function () {
    ...
    function init() {
        ...
        gameStarted = true;
        if (board) {
            (_a = document.getElementById("game-container")) === null || _a === void 0 ? void 0 : _a.removeChild(board.element);
        }
    ...
    class Board {
        constructor(size) {
            ...
            this.color = "#ccc";
            (_a = document.getElementById("game-container")) === null || _a === void 0 ? void 0 : _a.appendChild(this.element);
        ...
        createScoreBoard() {
            ...
            if (!scoreElement) {
                ...
                (_a = document.getElementById("game-container")) === null || _a === void 0 ? void 0 : _a.appendChild(scoreElement);
            }
        }
        updateScore() {
        ...
        gameOverMessage() {
            ...
            (_a = document.getElementById("game-container")) === null || _a === void 0 ? void 0 : _a.appendChild(messageElement);
        }
        clearGameOverMessage() {
            var _a;
            const messageElement = document.getElementById('game-over');
            if (messageElement) {
                (_a = document.getElementById("game-container")) === null || _a === void 0 ? void 0 : _a.removeChild(messageElement);
            }
        }
    }
    class Snake {
        ...
        walk() {
            ...
            let newHead = [head[0], head[1]]; // Inicialize newHead
